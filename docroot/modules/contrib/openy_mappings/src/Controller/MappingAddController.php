...
/**
 * Provides a controller for adding a new mapping.
 *
...
class MappingAddController extends ControllerBase {
  ...
  public function add(Request $request) {
    ...
    return ['#theme' => 'mapping_content_add_list', '#content' => $types];
  }

  /**
   * Presents the creation form for mapping entities of given bundle/type.
   *
   * @param \Drupal\Core\Entity\EntityInterface $mapping_type
