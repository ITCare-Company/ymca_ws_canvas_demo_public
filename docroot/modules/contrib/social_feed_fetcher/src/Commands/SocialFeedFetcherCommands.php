    ...
    foreach ($queuesID as $queueID) {
      ...
      while ($item = $queue->claimItem()) {
        try {
          ...
          \Drupal\Component\Utility\DeprecationHelper::backwardsCompatibleCall(\Drupal::VERSION, '10.1.0', fn() => \Drupal\Core\Utility\Error::logException(\Drupal::logger('npq'), $e), fn() => watchdog_exception('npq', $e));
        }
      }
    }
  }
