...
class UrlHelperTest extends TestCase {
   ...
   *
   * @dataProvider providerTestParseString
   * @covers ::parseString
   *
   ...
   *   The expected array.
   */
  public function testParseString($queryString, $queryArray) {
    $result = UrlHelper::parseString($queryString);
    $this->assertSame($queryArray, $result);
  }

  /**
   * Provides data for testParseString().
   *
   * @return array
   *   An array of test cases. Each comprises a querystring and its array
   *   counterpart.
   */
  public function providerTestParseString() {
    $data = [
      ['one', ['one' => '']],
      ['one=1', ['one' => '1']],
      ['one=1&two=2', ['one' => '1', 'two' => '2']],
      ['o%20e=1&two=2', ['o_e' => '1', 'two' => '2']],
      ['o%20e=1&%26=2', ['o_e' => '1', '&' => '2']],
      ['one=1&one=1', ['one' => ['1', '1']]],
      ['one=1&one=2', ['one' => ['1', '2']]],
      ['arr[0]=1&arr[1]=2', ['arr' => ['1', '2']]],
      ['arr[0][0]=1&arr[0][1]=2', ['arr' => [['1', '2']]]],
      ['arr[0][0]=1&arr[0][1]=2&one=1&one=2', ['arr' => [['1', '2']], 'one' => ['1', '2']]],
      ['arr[]=1&arr[]=2', ['arr' => ['1', '2']]],
      ['arr[][]=1&arr[][]=2', ['arr' => [['1'], ['2']]]],
      ['arr=1&arr[]=2', ['arr' => ['2']]],
      ['a=1&b[]=2', ['a' => '1', 'b' => ['2']]],
